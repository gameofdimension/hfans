...
# --capture-range=cudaProfilerApi nsys profile -w true \
# -t cuda,nvtx,osrt,cudnn,cublas -s cpu  --capture-range=cudaProfilerApi \
# --stop-on-range-end=true --cudabacktrace=true -x true -o my_profile \
# python main.py
