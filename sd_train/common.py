...
def get_hidden_states_sdxl(
    ...
    model_max_length1: int,
    model_max_length2: int,
    eos_token_id2,
    ...
    input_ids1 = input_ids1.reshape(
        (-1, model_max_length1))  # batch_size*n, 77
    input_ids2 = input_ids2.reshape(
        (-1, model_max_length2))  # batch_size*n, 77
    ...
    pool2 = pool_workaround(
        ...
        input_ids2, eos_token_id2)  # type: ignore
...
class SDXLModel(torch.nn.Module):
    ...
    def forward(
            ...
            time_ids: torch.Tensor, model_max_length1,
            model_max_length2, eos_token_id2):
